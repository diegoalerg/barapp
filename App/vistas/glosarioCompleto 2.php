    ...
    <script>
        ...
        */
        ...
        $().ready( function() {
            ...
            $.post('<?=DOMAIN?>/controlTerminos/obtenerTerminosLimit', { 'iniciar' : iniciar, 'articulos_por_pagina' : articulos_por_pagina }, refrescar,'json').done(function( data, textStatus, jqXHR) {
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                ...
                <div class="collapse navbar-collapse" id="menu">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="navbar-item dropdown"><a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" data-target="desplegable">Product</a>
            ...
            <div class="container">
                ...
                <nav aria-label="Page navigation example">
                                <ul class="pagination">
                                    ...
                                    "><a href="<?= DOMAIN?>/controlTerminos/glosarioCompleto?pagina=<?php echo intval($_GET['pagina']) - 1 ?>" class="page-link" >Anterior</a></li>

                                    <?php for ($i=0; $i < $paginas ; $i++): ?>
                                    <li class="page-item <?php echo intval($_GET['pagina'])== $i+1 ? 'active' : '' ?>">
                                    <a href="<?=DOMAIN?>/controlTerminos/glosarioCompleto?pagina=<?php echo $i +1 ?>" class="page-link"><?php echo $i +1 ?></a>
                                    </li>
                                    <?php endfor ?>
                       

                                    <li class="page-item <?php echo intval($_GET['pagina'])>=$paginas? 'disabled' : '' ?>
                                    "><a href="<?= DOMAIN?>/controlTerminos/glosarioCompleto?pagina=<?php echo intval($_GET['pagina']) + 1 ?>" class="page-link">Siguiente</a></li>
