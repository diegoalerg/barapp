    ...
    <div class="container-fluid p-0">
      ...
      <div class="row no-gutters">
        ...
        <div class="col-lg-6 order-lg-1 my-auto showcase-text">
          ...
          <p class="lead mb-0">La magia de una organización sólida es la facilidad para delegar tareas. El diseño amigable de Eventario facilita por mucho la engorrosa tarea de contar artículos y decidir cuantos comprar para la semana/mes inclusive si se hace por primera vez.</p>
        </div>
      </div>
    </div>
  </section>
